...
namespace DMCCR
{
    ...
    public sealed class Player : PhysicsObject
    {
        ...
        public Player(Stage stagePlayer, PhysicsLayer physicsLayer) : base(stagePlayer, false)
        {
            ...
            _playerTextureRight = new Texture(Game, System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DMCCR.Textures.PlayerRight.png"));
            _playerTextureLeft = new Texture(Game, System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DMCCR.Textures.PlayerLeft.png"));
            _textureRenderer = new TextureRenderer(this, 2);
            _textureRenderer.Texture = _playerTextureRight;
            deathParticles = new ParticleSystem(this, new Texture(Game, System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DMCCR.Textures.Death Particle Texture.png")), 3);
