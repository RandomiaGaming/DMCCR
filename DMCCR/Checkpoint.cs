...
namespace DMCCR
{
    public sealed class Checkpoint : PhysicsObject
    {
        ...
        public Checkpoint(Stage stagePlayer, PhysicsLayer physicsLayer) : base(stagePlayer, false)
        {
            ...
            _checkPointLockedTexture = new Texture(Game, System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DMCCR.Textures.Checkpoint Locked.png"));
            _checkPointUnlockedTexture = new Texture(Game, System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DMCCR.Textures.Checkpoint Unlocked.png"));
