...
namespace EpsilonEngine
{
    public sealed class Texture
    {
        ...
        public Texture(Game game, ushort width, ushort height)
        {
            ...
            XNABase = new Microsoft.Xna.Framework.Graphics.Texture2D(game.GameInterface.XNAGraphicsDevice, width, height);
        }
        public Texture(Game engine, ushort width, ushort height, Color[] data)
        {
           ...
           Width = width;
            ...
            XNABase = new Microsoft.Xna.Framework.Graphics.Texture2D(engine.GameInterface.XNAGraphicsDevice, width, height);
        ...
        public Texture(Game engine, string filePath)
        {
            ...
            XNABase = Microsoft.Xna.Framework.Graphics.Texture2D.FromFile(engine.GameInterface.XNAGraphicsDevice, filePath);
        ...
        public Texture(Game engine, Stream stream)
        {
            ...
            XNABase = Microsoft.Xna.Framework.Graphics.Texture2D.FromStream(engine.GameInterface.XNAGraphicsDevice, stream);
        ...
        public Texture(Game engine, Microsoft.Xna.Framework.Graphics.Texture2D source)
        {
            ...
            if(source.GraphicsDevice != engine.GameInterface.XNAGraphicsDevice)
            {
